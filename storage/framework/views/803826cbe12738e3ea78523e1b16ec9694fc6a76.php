<section class="layout-pt-md layout-pb-md bravo-list-event layout_<?php echo e($style_list); ?>">
    <div data-anim-wrap class="container">
        <div data-anim-child="slide-up delay-1" class="row  y-gap-20 justify-between items-end">
            ...
            <div class="col-auto">
                <a href="<?php echo e(route('event.search')); ?>" class="button -md -blue-1 bg-blue-1-05 text-blue-1">
                    <?php echo e(__('More')); ?>
...
</section><?php /**PATH C:\xampp\htdocs\gotrip\themes/GoTrip/Event/Views/frontend/blocks/list-event/style_1.blade.php ENDPATH**/ ?>