            ...
            <div class="row y-gap-15 items-center justify-between">
                <div class="col-auto">
                    <div class="text-14 text-light-1">
                        ...
                        <span class="text-20 fw-500 text-dark-1">{{ $row->display_price }} </span> {{ __('nights') }}
                    </div>
                </div>
                                    ...
                                    <div class="bg-white px-30 py-30 rounded-4">
                                        <div class="row y-gap-10 justify-between items-center form-guest-search">
                                            <div class="col-auto">
                                                ...
                                                <div class="text-14 lh-12 text-light-1 mt-5 render check-in-render">{{__('Ages 12+')}}</div>
                                            </div>
                                            <div class="col-auto">
                                        ...
                                        <div class="row y-gap-10 justify-between items-center form-guest-search">
                                            <div class="col-auto">
                                                ...
                                                <div class="text-14 lh-12 text-light-1 mt-5 render check-in-render">{{__('Ages 2–12')}}</div>
                                            </div>
