    <div class="py-30 px-30 bg-white rounded-4 base-tr mt-30" data-x="flight-item-{{$row->id}}" data-x-toggle="shadow-{{$row->id}}">
            ...
            <div class="col">
                <div class="row y-gap-10 items-center">
                    ...
                    <div class="col-md-auto">
                        <div class="text-15 text-light-1 px-20 md:px-0">{{$row->duration.'h'}}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-auto">
                <div class="d-flex items-center h-full">
                    ...
                    <div>
                        ...
                        <div class="accordion__button">
                            @if($row->can_book)
                                <a @click="openModalBook('{{$row->id}}')" href=""  onclick="event.preventDefault()" class="button -dark-1 px-30 h-50 bg-blue-1 text-white">{{__("Choose")}} <div class="icon-arrow-top-right ml-15"></div></a>
                            @else
