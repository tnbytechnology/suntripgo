        ...
        <div class="col-md">
            <div class="row x-gap-10 items-center">
                @if(setting_item('event_enable_review'))
                    <div class="col-auto">
                        <p class="text-14 lh-14 mb-5">{{ $reviewData['review_text'] }} {{ $score_total  }}</p>
                    </div>
                    <div class="col-auto">
                ...
                @endif
                <div class="col-auto">
                    <p class="text-14 lh-14 mb-5">{{__(":number% of guests recommend",['number'=>$row->recommend_percent])}}</p>
                </div>
            </div>
            ...
            @endif
            <p class="text-14 lh-14 mt-5">{{$location->name ?? ''}}</p>
