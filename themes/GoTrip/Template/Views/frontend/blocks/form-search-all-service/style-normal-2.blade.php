                ...
                <div data-anim-child="slide-up delay-6" class="masthead__tabs">
                    <div class="tabs -bookmark js-tabs">
                        <div class="tabs__controls d-flex items-center js-tabs-controls">
                            ...
                            @if($service_types)
                                @foreach($service_types as $k => $service_type)
                                    ...
                                    @endphp
                                    <div class="">
                                        <button class="tabs__button px-30 py-20 rounded-4 fw-600 text-white js-tabs-button @if($k==0) is-tab-el-active @endif" data-tab-target=".-tab-item-{{$service_type}}">
                        ...
                        <div class="tabs__content js-tabs-content">
                            @if($service_types)
                                @foreach($service_types as $k => $service_type)
                                    <div class="tabs__pane -tab-item-{{$service_type}} @if($k==0) is-tab-el-active @endif">
